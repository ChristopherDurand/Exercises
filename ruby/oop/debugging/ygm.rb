...
#The issue is that Mailing is never included anywhere in the heirarchy, so when you say .send to johns postal service,
#it's using Object#send. this tries to call a method of the naem of the first argument.
#To fix this simply include Mailing in Communications Provider.
